package com.dicoding.testmata.ml;
...
public final class KeratitisMetadata {
  @NonNull
  ...
  private KeratitisMetadata(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "keratitis_metadata.tflite", options);
    ...
    ImageProcessor.Builder imageProcessorBuilder = new ImageProcessor.Builder()
      .add(new ResizeOp(96, 183, ResizeMethod.NEAREST_NEIGHBOR))
  ...
  @NonNull
  public static KeratitisMetadata newInstance(@NonNull Context context) throws IOException {
    return new KeratitisMetadata(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static KeratitisMetadata newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new KeratitisMetadata(context, options);
  }
