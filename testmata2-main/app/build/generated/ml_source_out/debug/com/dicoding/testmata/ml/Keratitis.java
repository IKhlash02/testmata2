...
public final class Keratitis {
  @NonNull
  private final Model model;

  private Keratitis(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "keratitis.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Keratitis newInstance(@NonNull Context context) throws IOException {
    return new Keratitis(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Keratitis newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new Keratitis(context, options);
  }
